...
export { ACCOUNT_PREFERENCE, ACCOUNT_SECURITY, APPOINTMENTS, BUSINESS_PROFILE, CERTIFICATES, CONTINUE_SIGN_UP, EARNINGS, FORGOT_PASSWORD, HOME, MANAGE_SERVICES, PRIVACY_POLICY, PROFILE, PROFILE_INFORMATION, RESET_PASSWORD, SIGN_IN, SIGN_UP, SUPPORT, TERMS_OF_SERVICES, VERIFY_EMAIL, VERIFY_IDENTITY };
